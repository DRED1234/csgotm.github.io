<?php include ("header.php") ?>
	<section class="content">
	    <div class="container">
		    <ul class="breadcrumb">
               ...
               <li class="active">Новые обращения</li>
            </ul>
			<div class="panel panel-default">
            <div class="panel-heading">Новые обращения в поддержку</div>
   ...
   $result = mysql_query("SELECT * FROM support WHERE status = 0 LIMIT $start, 15");
   ...
   $result = mysql_query("SELECT COUNT(*) FROM support WHERE status = 0");
   ...
   {
    $t_p1 = $t_p-1;
     echo '<li><a href="new-support.php?page='.$t_p1.'" rel="next">';
 ...
 ?>
   ...
   for($i = 1; $i<= $all_page; $i++)
   {
    ...
    echo '<a href="new-support.php?page='.$i.'"><span>'.$i.'</span></a></li>'; 
   }
   ...
   ?>
         ...
         <?php
            ...
            {
                $t_p2 = $t_p+1;
               echo '<li><a href="new-support.php?page='.$t_p2.'" rel="next">';
            }
