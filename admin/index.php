<?php include ("header.php") ?>
	<section class="content">
	    <div class="container">
		<div class="jumbotron">
        <div class="page-header"><h3>Добро пожаловать Admin!</h3></div>
        <ul>
            <?php $result = mysql_query("SELECT COUNT(*) FROM users"); $data = mysql_fetch_row($result); ?>
            
        	<li>Пользователей: <?php echo $data[0]; ?> </li>
        	<?php $result = mysql_query("SELECT COUNT(*) FROM prodazi WHERE status = 1"); $data = mysql_fetch_row($result); ?>
        	
        	<li>Продаж: <?php echo $data[0]; ?></li>
        </ul>
        <div class="page-header"><h4>Рассылка Пользователям</h4></div>
        <form class="form-horizontal" method="POST" action="http://shaltay.com/admin/mail/webm">
